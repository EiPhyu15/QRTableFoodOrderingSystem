...
namespace QRTableFoodOrderingSystem.Controllers
{
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TableNumber,SeatCount,IsAvaliable")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TableNumber,SeatCount,IsAvaliable")] Table table)
        {
        ...
        {
            return _context.Table.Any(e => e.TableNumber == id);
        }
    }
}
