...
namespace QRTableFoodOrderingSystem.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,Amount,PaymentMethod,PaymentDate,OrderId")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,Amount,PaymentMethod,PaymentDate,OrderId")] Payment payment)
        {
