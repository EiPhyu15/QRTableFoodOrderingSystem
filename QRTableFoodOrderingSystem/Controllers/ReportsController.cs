...
namespace QRTableFoodOrderingSystem.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReportId,ReportName,ReportDate,StaffId")] Report report)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReportId,ReportName,ReportDate,StaffId")] Report report)
        {
